...
OrderListStore.dispatchToken = AppDispatcher.register(function(action) {
	// console.log(action);
	switch (action.type) {
	case ActionTypes.ORDER_LIST_RECEIVE_DATA:
	...
	case ActionTypes.ORDER_LIST_RECEIVE_NEXT_PAGE_DATA:
